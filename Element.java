...
public abstract class Element {
	protected String genreName = new String();
	protected ArrayList<Element> genre;
	/**
	...
	protected void addChild(Element b) throws IllegalArgumentException{
		...
		// TODO implement this (should throw an exception if trying to add to a leaf object);
		// check if it is an album or a genre to be added
		if(!this.hasChildren()){
			throw new IllegalArgumentException();
		}else{
			if(!this.getChildren().contains(b)){
				this.genre.add(b);	
			}
		}
	}
